...
class PickRestaurant extends React.Component {
    ...
    componentDidMount() {
        Promise.all([
            fetch('https://whiletrueconnect.ddns.net/restaurant/GetNotVisited', {
                method: 'get',
                headers: {
            ...
            .then(res => res.json()),
            fetch('https://whiletrueconnect.ddns.net/restaurant/GetVisitedSingle',  {
                method: 'get',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
    ...
    handleRandom() {
        ...
        if (this.state.restaurants.data.length <= 0) {
            ...
            fetch("https://whiletrueconnect.ddns.net/restaurant", {
                method: 'put',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
